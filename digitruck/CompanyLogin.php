...
if (isset($_POST['login'])) {
    ...
    $result = mysql_query("SELECT * FROM dealerregistration WHERE EmailID = '" . $email. "' and Password = '" . $password . "' and Status = '".'Unblock'."'");

    if ($row = mysql_fetch_array($result)) {
        $_SESSION['usr_id'] = $row['DealerId'];
